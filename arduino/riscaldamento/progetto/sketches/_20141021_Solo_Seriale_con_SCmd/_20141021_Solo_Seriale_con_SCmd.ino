...
void serialCmdSetup () {
  ...
  SCmd.addCommand( "GET", cmdGetStatus ); // Restituisce lo stato delle variabili interne
  SCmd.addCommand( "GET-RA", cmdGetStatusRA ); // Restituisce lo stato delle variabili interne
  SCmd.addDefaultHandler( cmdGetStatus ); // Handler for command that isn't matched (says "What?")
